...
// =OFFSET($A$1,COLUMNS($A1:A1)-1+(ROWS($1:1)-1)*3,0)
 ...
 macro "Jurgen-Analyze Action Tool - Txyssc" {
...
print("worked on: " + raw_name00 + "\n");
raw_name_m = substring(raw_name00, 0 , lengthOf(raw_name00)-4) + "-m.tif";
name_m = substring(name00, 0 , lengthOf(name00)-4) + "-m.tif";
